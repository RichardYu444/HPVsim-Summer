#!/usr/bin/env python3
"""
Vendored, unmodified, from "Francesco simple codes/bipartite_network_model_bundle/
simple_bipartite_network_model.py". Treat that path as the upstream reference copy;
edit this file only to pull in upstream changes, not to add HPVsim-specific logic
(that belongs in francesco_network.py).
